...
DEVICE_PATH := device/onyx/Poke5S
...
TARGET_KERNEL_CONFIG := Poke5S_defconfig
TARGET_KERNEL_SOURCE := kernel/onyx/Poke5S
...
BOARD_USES_DRM := true
HAS_DRM :=true
TARGET_RECOVERY_FSTAB := $(DEVICE_PATH)/recovery/root/fstab.emmc

# Debug
TWRP_INCLUDE_LOGCAT := true
TARGET_USES_LOGD := true

TW_DEVICE_VERSION := NSZ
